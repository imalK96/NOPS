			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="ElectionResultUI">Results</a></li>
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-12 col-md-12">
							<h6 class="text-uppercase">Don't look further, This is your chance</h6>
							<h1>
								Cast your vote			
							</h1>
							<!--<p class="text-white">
				...
				<div class="container">
					<div class="row align-items-center countdown-wrap no-gutters">
						<div class="col-lg-6 countdown-left">
							<h1>Election is knocking at door</h1>
							<p>
					...
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-counter">
								...
								<h5><span class="counter">22</span></h5>
								<p>
									Registerd parties
								</p>
							</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="styles/img/srilanka/Election-Secretariat11-768x480.jpg" alt="" >								
							</div>
							<p class="date">10 Jan 2018</p>
							<a href="#"><h4>The election commision</h4></a>
							<p>
								The Election Commission was established on the 13th November, 2015. The Chairman of the Election Commission is Mr. Mahinda Deshapriya.
							</p>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="styles/img/srilanka/ranil-wickramasinghe-696x390.jpg" alt="">								
							</div>
							<p class="date">10 Jan 2018</p>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="styles/img/srilanka/qwe.jpg" alt="">								
							</div>
							<p class="date">10 Jan 2018</p>
							<a href="#"><h4>Addiction When Gambling
							Becomes A Problem</h4></a>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="styles/img/srilanka/Ranil-and-Mahinda.jpg" alt="">								
							</div>
							<p class="date">10 Jan 2018</p>
							<a href="#"><h4>Addiction When Gambling
							Becomes A Problem</h4></a>
