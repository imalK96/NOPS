					...
					<div class="row">		
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="ImalGetVoterServlet" >
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/download11.jpg" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Voters</h4>
								        <span></span>								        
						...
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
									<div class="overlay overlay-bg"></div>
								    <a href="candidateTable">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/abc.JPG" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Candidates</h4>
								        <span></span>								        
								        <p>View, Add, Update, Delete</p>
								      </div>
								    </a>
						...
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="thTable">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/pp.jpg" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Political parties</h4>
								        <span></span>
								        <p>View, Add, Update, Delete</p>
								      </div>
								    </a>
						...
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
									<div class="overlay overlay-bg"></div>
								    <a href="ElectionTable">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/paa.jpg" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Elections</h4>
								        <span></span>
								        <p>View, Add, Update, Delete</p>
								      </div>
								    </a>
