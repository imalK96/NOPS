...
<div class="containerForm">
  <form id="contact" method="POST" action="ThanujaAddPP">
    <h3>Political party</h3>

    <fieldset>
     	<label> Party Logo : </label>
		<input type = "text" name = "partyLogo" required autofocus>
    </fieldset>
    ...
    <fieldset>
		...
		<input type = "text" name = "abbreivation" required>
    </fieldset>
    
    <fieldset>
      	<label> Leader name : </label>
		<input type = "text" name = "ledName" required>
    </fieldset>
	...
	<fieldset>
		...
		<input type = "text" name = "offContact" required>
    </fieldset>
    
	<fieldset>
     	<label> Official email : </label>
		<input type = "text" name = "offEmail" required>
    </fieldset>
    
	<fieldset>
     	<label> Address number : </label>
		<input type = "text" name = "addNo" required>
    </fieldset>
    
	<fieldset>
     	<label> Address street : </label>
		<input type = "text" name = "addStreet" required>
    </fieldset>
    
	<fieldset>
     	<label> Address city : </label>
		<input type = "text" name = "addCity" required>
    </fieldset>
    
    <fieldset>
      <button name="re" type="submit" id="contact-submit" data-submit="...Sending">Add</button>
    </fieldset>
