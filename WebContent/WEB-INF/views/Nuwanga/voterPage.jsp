	...
	<head>
		...
		<body>	
	       ...
	       <div class="table-title">
            ...
            <div style="height: 50px; position : center"></div>

	       <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">						<h2><%if(request.getAttribute("error") != null){ %>
							<div class = "error">${error}</div>
							<%} %></h2>
					</div>
					...
					<div class="row">		
							...
							<div class="single-cat-widget">
								<div class="content relative">
									<div class="overlay overlay-bg"></div>
								      ...
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/ongoingelec.jpg" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Passed Election Name</h4>
								        <span></span>								        
								        <p>Passed an Election</p>
								      </div>
						...
						<div class="col-lg-4">
							<%
								    	...
								    	%>
								      	<form method="POST" action="NuwVotePartyServlet"> 
									  	<input type = "hidden" name = "vid" value = "<%=request.getAttribute("vid")%>"/>
										<input type = "hidden" name = "vac" value = "<%=request.getAttribute("vac")%>"/>
										<input type = "hidden" name = "eid" value = "<%=1%>"/>
										<input type = "submit" value = "Please Click to Vote the Ongoing Election" class="btn btn-success"/>
										</form>   
						</div>
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
									<div class="overlay overlay-bg"></div>
								      ...
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Next Election Name</h4>
								        <span></span>
