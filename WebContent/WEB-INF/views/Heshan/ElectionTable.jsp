...
<%@page import="com.nops.service.HeshServiceImpl"%>
<%@page import="com.nops.service.HeshService"%>
...
<div class="container">
           ...
           <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Manage <b>Election</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="register" class="btn btn-success"><span>Add New Election</span></a>
					</div>
                </div>
            </div>
        ...
        <table class="table" id="table1">
          ...
          <tbody>
			...
			<%
				...
				ArrayList<ElectionModel> al = hs.getAllElections();
            ...
            <tr>
              ...
              <td><%=e.getEcycle() %></td>
              <td>
				<form method="POST" action="HeshGetElectionServlet">
