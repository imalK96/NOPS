...
<html lang="zxx" class="no-js">
		...
		<%
			ElectionModel e = (ElectionModel)request.getAttribute("Elect");
		%>
			  
<div class="containerForm">
  <form id="contact" method="POST" action="HeshUpdateElectionServlet">
    <h3>Election</h3>
    
    
    <fieldset>
    	<label> ELection ID : </label>
		<input type = "text" name = "Eid" value ="<%=e.getEid()%>">
    </fieldset>
    ...
    <fieldset>
     	<label> Date : </label>
		<input type = "text" name = "Date" value = "<%=e.getDate()%>">
    </fieldset>
    
    <fieldset>
     	<label> Election Cycle : </label>
		<input type = "text" name = "Ecycle" value = "<%=e.getEcycle()%>">
    </fieldset>
    	
    <fieldset>
    	<input type = "hidden" name = "e" value = "<%=e.getEid()%>"/>
     	<button name="re" type="submit" id="contact-submit" data-submit="...Sending">Update</button> 
    </fieldset>    
  </form>
  
  <form id="contact" method="POST" action="HeshDeleteElectionServlet">
  	<fieldset>
    	<input type = "hidden" name = "e" value = "<%=e.getEid()%>"/>
